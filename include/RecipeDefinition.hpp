...
constexpr float POWER_MINER_100 = 30.0;
...
constexpr float POWER_PRESSURIZER_100 = 150.0;
constexpr float POWER_PRESSURIZER_150 = 150.0 * std::pow(1.50,1.6);
constexpr float POWER_PRESSURIZER_250 = 150.0 * std::pow(2.50,1.6);
...
constexpr float POWER_BLENDER = 75;
...
double overclockPower(double overclock)
{
	return std::pow(overclock, 1.6);
}

RecipeBook generateRecipes(double overclockLimestone, double overclockNitrogen)
{
	RecipeBook recipes;
	
	recipes[RECIPE_SOURCE_LIMESTONE_IMPURE] = {
		{RESOURCE_LIMESTONE, 120},
		{RESOURCE_POWER, -POWER_MINER_100}
	};
	recipes[RECIPE_SOURCE_LIMESTONE_NORMAL] = {
		{RESOURCE_LIMESTONE, 240 * overclockLimestone},
		{RESOURCE_POWER, -POWER_MINER_100 * overclockPower(overclockLimestone)}
	};
	...
	recipes[RECIPE_SOURCE_NITROGEN_WELL_A] = {
		{RESOURCE_NITROGEN_GAS, (0*30+1*60+6*120) * overclockNitrogen},
		{RESOURCE_POWER, -POWER_PRESSURIZER_100 * overclockPower(overclockNitrogen)}
	};
	recipes[RECIPE_SOURCE_NITROGEN_WELL_B] = {
		{RESOURCE_NITROGEN_GAS, (0*30+0*60+7*120) * overclockNitrogen},
		{RESOURCE_POWER, -POWER_PRESSURIZER_100 * overclockPower(overclockNitrogen)}
	};
	recipes[RECIPE_SOURCE_NITROGEN_WELL_C] = {
		{RESOURCE_NITROGEN_GAS, (0*30+0*60+7*120) * overclockNitrogen},
		{RESOURCE_POWER, -POWER_PRESSURIZER_100 * overclockPower(overclockNitrogen)}
	};
	recipes[RECIPE_SOURCE_NITROGEN_WELL_D] = {
		{RESOURCE_NITROGEN_GAS, (0*30+0*60+10*120) * overclockNitrogen},
		{RESOURCE_POWER, -POWER_PRESSURIZER_100 * overclockPower(overclockNitrogen)}
	};
	recipes[RECIPE_SOURCE_NITROGEN_WELL_E] = {
		{RESOURCE_NITROGEN_GAS, (2*30+2*60+4*120) * overclockNitrogen},
		{RESOURCE_POWER, -POWER_PRESSURIZER_100 * overclockPower(overclockNitrogen)}
	};
	recipes[RECIPE_SOURCE_NITROGEN_WELL_F] = {
		{RESOURCE_NITROGEN_GAS, (0*30+2*60+4*120) * overclockNitrogen},
		{RESOURCE_POWER, -POWER_PRESSURIZER_100 * overclockPower(overclockNitrogen)}
	};
	recipes[RECIPE_SOURCE_OIL_WELL_A] = {
		{RESOURCE_CRUDE_OIL, 0*75+3*150+3*300},
		{RESOURCE_POWER, -POWER_PRESSURIZER_250}
	};
	recipes[RECIPE_SOURCE_OIL_WELL_B] = {
		{RESOURCE_CRUDE_OIL, 6*75+0*150+0*300},
		{RESOURCE_POWER, -POWER_PRESSURIZER_250}
	};
	...
	recipes[RECIPE_PURE_ALUMINUM_INGOT] = {
		{RESOURCE_ALUMINUM_SCRAP, -60},
		{RESOURCE_ALUMINUM_INGOT, 30},
		{RESOURCE_POWER, -POWER_SMELTER}
	};
	
	recipes[RECIPE_ALUMINUM_INGOT] = {
		{RESOURCE_ALUMINUM_SCRAP, -90},
		{RESOURCE_SILICA, -75},
	...
	recipes[RECIPE_ALUMINUM_CASING] = {
		{RESOURCE_ALUMINUM_INGOT, -90},
		{RESOURCE_ALUMINUM_CASING, 60},
	...
	recipes[RECIPE_COPPER_POWDER] = {
		{RESOURCE_COPPER_INGOT, -300},
		{RESOURCE_COPPER_POWDER, 50},
		{RESOURCE_POWER, -POWER_CONSTRUCTOR}
	};
	...
	recipes[RECIPE_EMPTY_FLUID_TANK] = {
		{RESOURCE_ALUMINUM_INGOT, -60},
		{RESOURCE_EMPTY_FLUID_TANK, 60},
		{RESOURCE_POWER, -POWER_CONSTRUCTOR}
	};
	...
	recipes[RECIPE_ALCLAD_ALUMINUM_SHEET] = {
		{RESOURCE_ALUMINUM_INGOT, -30},
		{RESOURCE_COPPER_INGOT, -10},
		{RESOURCE_ALCLAD_ALUMINUM_SHEET, 30},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	recipes[RECIPE_ALCLAD_CASING] = {
		{RESOURCE_ALUMINUM_INGOT, -150},
		{RESOURCE_COPPER_INGOT, -75},
		{RESOURCE_ALUMINUM_CASING, 112.5},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	recipes[RECIPE_ASSEMBLY_DIRECTOR_SYSTEM] = {
		{RESOURCE_ADAPTIVE_CONTROL_UNIT, -1.5},
		{RESOURCE_SUPERCOMPUTER, -0.75},
		{RESOURCE_ASSEMBLY_DIRECTOR_SYSTEM, 0.75},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	...
	recipes[RECIPE_ELECTRIC_MOTOR] = {
		{RESOURCE_ELECTROMAGNETIC_CONTROL_ROD, -3.75},
		{RESOURCE_ROTOR, -7.5},
		{RESOURCE_MOTOR, 7.5},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	...
	recipes[RECIPE_ELECTROMAGNETIC_CONNECTION_ROD] = {
		{RESOURCE_STATOR, -8},
		{RESOURCE_HIGH_SPEED_CONNECTOR, -4},
		{RESOURCE_ELECTROMAGNETIC_CONTROL_ROD, 8},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	...
	recipes[RECIPE_ENCASED_PLUTONIUM_CELL] = {
		{RESOURCE_PLUTONIUM_PELLET, -10},
		{RESOURCE_CONCRETE, -20},
		{RESOURCE_ENCASED_PLUTONIUM_CELL, 5},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	...
	recipes[RECIPE_OC_SUPERCOMPUTER] = {
		{RESOURCE_RADIO_CONTROL_UNIT, -9},
		{RESOURCE_COOLING_SYSTEM, -9},
		{RESOURCE_SUPERCOMPUTER, 3},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	recipes[RECIPE_PLUTONIUM_FUEL_UNIT] = {
		{RESOURCE_ENCASED_PLUTONIUM_CELL, -10},
		{RESOURCE_PRESSURE_CONVERSION_CUBE, -0.5},
		{RESOURCE_PLUTONIUM_FUEL_ROD, 0.5},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	recipes[RECIPE_PRESSURE_CONVERSION_CUBE] = {
		{RESOURCE_FUSED_MODULAR_FRAME, -1},
		{RESOURCE_RADIO_CONTROL_UNIT, -2},
		{RESOURCE_PRESSURE_CONVERSION_CUBE, 1},
		{RESOURCE_POWER, -POWER_ASSEMBLER}
	};
	...
	recipes[RECIPE_AUTOMATED_MINER] = {
		{RESOURCE_MOTOR, -1},
		{RESOURCE_STEEL_PIPE, -4},
		{RESOURCE_IRON_ROD, -4},
		{RESOURCE_IRON_PLATE, -2},
		{RESOURCE_PORTABLE_MINER, 1},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	...
	recipes[RECIPE_CLASSIC_BATTERY] = {
		{RESOURCE_ALCLAD_ALUMINUM_SHEET, -52.5},
		{RESOURCE_WIRE, -90},
		{RESOURCE_SULFUR, -45},
		{RESOURCE_PLASTIC, -60},
		{RESOURCE_BATTERY, 30},
	...
	recipes[RECIPE_HIGH_SPEED_WIRING] = {
	...
	recipes[RECIPE_INFUSED_URANIUM_CELL] = {
		...
		{RESOURCE_SULFUR, -25},
		{RESOURCE_SILICA, -15},
		{RESOURCE_QUICKWIRE, -75},
		{RESOURCE_ENCASED_URANIUM_CELL, 20},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	...
	recipes[RECIPE_IODINE_INFUSED_FILTER] = {
		...
		{RESOURCE_ALUMINUM_CASING, -3.75},
		{RESOURCE_IODINE_INFUSED_FILTER, 3.75},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	recipes[RECIPE_MAGNETIC_FIELD_GENERATOR] = {
		{RESOURCE_VERSATILE_FRAMEWORK, -2.5},
		{RESOURCE_ELECTROMAGNETIC_CONTROL_ROD, -1},
		{RESOURCE_BATTERY, -5},
		{RESOURCE_MAGNETIC_FIELD_GENERATOR, 1},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	...
	recipes[RECIPE_PLUTONIUM_FUEL_ROD] = {
		{RESOURCE_ENCASED_PLUTONIUM_CELL, -7.5},
		{RESOURCE_STEEL_BEAM, -4.5},
		{RESOURCE_ELECTROMAGNETIC_CONTROL_ROD, -1.5},
		{RESOURCE_HEAT_SINK, -2.5},
		{RESOURCE_PLUTONIUM_FUEL_ROD, 0.25},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	recipes[RECIPE_RADIO_CONNECTION_UNIT] = {
		{RESOURCE_HEAT_SINK, -15},
		{RESOURCE_HIGH_SPEED_CONNECTOR, -7.5},
		{RESOURCE_QUARTZ_CRYSTAL, -45},
		{RESOURCE_RADIO_CONTROL_UNIT, 3.75},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	recipes[RECIPE_RADIO_CONTROL_SYSTEM] = {
		{RESOURCE_CRYSTAL_OSCILLATOR, -1.5},
		{RESOURCE_CIRCUIT_BOARD, -15},
		{RESOURCE_ALUMINUM_CASING, -90},
		{RESOURCE_RUBBER, -45},
		{RESOURCE_RADIO_CONTROL_UNIT, 4.5},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	recipes[RECIPE_RADIO_CONTROL_UNIT] = {
		{RESOURCE_ALUMINUM_CASING, -40},
		{RESOURCE_CRYSTAL_OSCILLATOR, -1.25},
		{RESOURCE_COMPUTER, -1.25},
	...
	recipes[RECIPE_SUPER_STATE_COMPUTER] = {
		{RESOURCE_COMPUTER, -3.6},
		{RESOURCE_ELECTROMAGNETIC_CONTROL_ROD, -2.4},
		{RESOURCE_BATTERY, -24},
		{RESOURCE_WIRE, -54},
		{RESOURCE_SUPERCOMPUTER, 2.4},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	...
	recipes[RECIPE_THERMAL_PROPULSION_ROCKET] = {
		{RESOURCE_MODULAR_ENGINE, -2.5},
		{RESOURCE_TURBO_MOTOR, -1},
		{RESOURCE_COOLING_SYSTEM, -3},
		{RESOURCE_FUSED_MODULAR_FRAME, -1},
		{RESOURCE_THERMAL_PROPULSION_ROCKET, 1},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	recipes[RECIPE_TURBO_ELECTRIC_MOTOR] = {
		{RESOURCE_MOTOR, -6.5625},
		{RESOURCE_RADIO_CONTROL_UNIT, -8.4375},
		{RESOURCE_ELECTROMAGNETIC_CONTROL_ROD, -4.6875},
		{RESOURCE_ROTOR, -6.5625},
		{RESOURCE_TURBO_MOTOR, 2.8125},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	recipes[RECIPE_TURBO_MOTOR] = {
		{RESOURCE_COOLING_SYSTEM, -7.5},
		{RESOURCE_RADIO_CONTROL_UNIT, -3.75},
		{RESOURCE_MOTOR, -7.5},
		{RESOURCE_RUBBER, -45},
	...
	recipes[RECIPE_TURBO_PRESSURE_MOTOR] = {
		{RESOURCE_MOTOR, -7.5},
		{RESOURCE_PRESSURE_CONVERSION_CUBE, -1.875},
		{RESOURCE_PACKAGED_NITROGEN_GAS, -45},
		{RESOURCE_STATOR, -15},
		{RESOURCE_TURBO_MOTOR, 3.75},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	recipes[RECIPE_URANIUM_FUEL_ROD] = {
		{RESOURCE_ENCASED_URANIUM_CELL, -20},
		{RESOURCE_ENCASED_INDUSTRIAL_BEAM, -1.2},
		{RESOURCE_ELECTROMAGNETIC_CONTROL_ROD, -2},
		{RESOURCE_URANIUM_FUEL_ROD, 0.4},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};
	recipes[RECIPE_URANIUM_FUEL_UNIT] = {
		{RESOURCE_ENCASED_URANIUM_CELL, -20},
		{RESOURCE_ELECTROMAGNETIC_CONTROL_ROD, -2},
		{RESOURCE_CRYSTAL_OSCILLATOR, -0.6},
		{RESOURCE_BEACON, -1.2},
		{RESOURCE_URANIUM_FUEL_ROD, 0.6},
		{RESOURCE_POWER, -POWER_MANUFACTURER}
	};

	recipes[RECIPE_ALUMINA_SOLUTION] = {
		{RESOURCE_BAUXITE, -120},
		{RESOURCE_WATER, -180},
		{RESOURCE_ALUMINA_SOLUTION, 120},
		{RESOURCE_SILICA, 50},
	...
	recipes[RECIPE_ELECTRODE_ALUMINUM_SCRAP] = {
		{RESOURCE_ALUMINA_SOLUTION, -180},
		{RESOURCE_PETROLEUM_COKE, -60},
		{RESOURCE_ALUMINUM_SCRAP, 300},
		{RESOURCE_WATER, 105},
		{RESOURCE_POWER, -POWER_REFINERY}
	};
	recipes[RECIPE_FUEL] = {
	...
	recipes[RECIPE_SLOPPY_ALUMINA] = {
		{RESOURCE_BAUXITE, -200},
		{RESOURCE_WATER, -200},
		{RESOURCE_ALUMINA_SOLUTION, 240},
		{RESOURCE_POWER, -POWER_REFINERY}
	};
	...
	recipes[RECIPE_PACKAGED_ALUMINA_SOLUTION] = {
		{RESOURCE_ALUMINA_SOLUTION, -120},
		{RESOURCE_EMPTY_CANISTER, -120},
		{RESOURCE_PACKAGED_ALUMINA_SOLUTION, 120},
	...
	recipes[RECIPE_PACKAGED_NITRIC_ACID] = {
		{RESOURCE_NITRIC_ACID, -30},
		{RESOURCE_EMPTY_FLUID_TANK, -30},
		{RESOURCE_PACKAGED_NITRIC_ACID, 30},
		{RESOURCE_POWER, -POWER_PACKAGER}
	};
	recipes[RECIPE_PACKAGED_NITROGEN_GAS] = {
		{RESOURCE_NITROGEN_GAS, -240},
		{RESOURCE_EMPTY_FLUID_TANK, -60},
		{RESOURCE_PACKAGED_NITROGEN_GAS, 60},
		{RESOURCE_POWER, -POWER_PACKAGER}
	};
	...
	recipes[RECIPE_PACKAGED_SULFURIC_ACID] = {
		{RESOURCE_SULFURIC_ACID, -40},
		{RESOURCE_EMPTY_CANISTER, -40},
		{RESOURCE_PACKAGED_SULFURIC_ACID, 40},
		{RESOURCE_POWER, -POWER_PACKAGER}
	};
	...
	recipes[RECIPE_UNPACKAGE_ALUMINA_SOLUTION] = {
		{RESOURCE_PACKAGED_ALUMINA_SOLUTION, -120},
		{RESOURCE_ALUMINA_SOLUTION, 120},
		{RESOURCE_EMPTY_CANISTER, 120},
		{RESOURCE_POWER, -POWER_REFINERY}//TODO: really?
	};
	...
	recipes[RECIPE_UNPACKAGE_NITRIC_ACID] = {
		{RESOURCE_PACKAGED_NITRIC_ACID, -20},
		{RESOURCE_NITRIC_ACID, 20},
		{RESOURCE_EMPTY_FLUID_TANK, 20},
		{RESOURCE_POWER, -POWER_PACKAGER}
	};
	recipes[RECIPE_UNPACKAGE_NITROGEN_GAS] = {
		{RESOURCE_PACKAGED_NITROGEN_GAS, -60},
		{RESOURCE_NITROGEN_GAS, 240},
		{RESOURCE_EMPTY_FLUID_TANK, 60},
		{RESOURCE_POWER, -POWER_PACKAGER}
	...
	recipes[RECIPE_UNPACKAGE_SULFURIC_ACID] = {
		{RESOURCE_PACKAGED_SULFURIC_ACID, -60},
	...
	recipes[RECIPE_BATTERY] = {
		{RESOURCE_SULFURIC_ACID, -50},
		{RESOURCE_ALUMINA_SOLUTION, -40},
		{RESOURCE_ALUMINUM_CASING, -20},
		{RESOURCE_BATTERY, 20},
		{RESOURCE_WATER, 30},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_COOLING_DEVICE] = {
		{RESOURCE_HEAT_SINK, -9.375},
		{RESOURCE_MOTOR, -1.875},
		{RESOURCE_NITROGEN_GAS, -45},
		{RESOURCE_COOLING_SYSTEM, 3.75},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_COOLING_SYSTEM] = {
		{RESOURCE_HEAT_SINK, -12},
		{RESOURCE_RUBBER, -12},
		{RESOURCE_WATER, -30},
		{RESOURCE_NITROGEN_GAS, -150},
		{RESOURCE_COOLING_SYSTEM, 6},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_DILUTED_FUEL] = {
		{RESOURCE_HEAVY_OIL_RESIDUE, -50},
		{RESOURCE_WATER, -100},
		{RESOURCE_FUEL, 100},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_ENCASED_URANIUM_CELL] = {
		{RESOURCE_URANIUM, -50},
		{RESOURCE_CONCRETE, -15},
		{RESOURCE_SULFURIC_ACID, -30},
		{RESOURCE_ENCASED_URANIUM_CELL, 25},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_FERTILE_URANIUM] = {
		{RESOURCE_URANIUM, -25},
		{RESOURCE_URANIUM_WASTE, -25},
		{RESOURCE_NITRIC_ACID, -15},
		{RESOURCE_SULFURIC_ACID, -25},
		{RESOURCE_NON_FISSILE_URANIUM, 100},
		{RESOURCE_WATER, 40},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_FUSED_MODULAR_FRAME] = {
		{RESOURCE_HEAVY_MODULAR_FRAME, -1.5},
		{RESOURCE_ALUMINUM_CASING, -75},
		{RESOURCE_NITROGEN_GAS, -37.5},
		{RESOURCE_FUSED_MODULAR_FRAME, 1.5},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_HEAT_FUSED_FRAME] = {
		{RESOURCE_HEAVY_MODULAR_FRAME, -3},
		{RESOURCE_ALUMINUM_INGOT, -150},
		{RESOURCE_NITRIC_ACID, -24},
		{RESOURCE_FUEL, -30},
		{RESOURCE_FUSED_MODULAR_FRAME, 3},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_INSTANT_SCRAP] = {
		{RESOURCE_BAUXITE, -150},
		{RESOURCE_COAL, -100},
		{RESOURCE_SULFURIC_ACID, -50},
		{RESOURCE_WATER, -10},
		{RESOURCE_ALUMINUM_SCRAP, 300},
	...
	recipes[RECIPE_NITRIC_ACID] = {
		{RESOURCE_NITROGEN_GAS, -120},
		{RESOURCE_WATER, -30},
		{RESOURCE_IRON_PLATE, -10},
		{RESOURCE_NITRIC_ACID, 30},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_NON_FISSILE_URANIUM] = {
		{RESOURCE_URANIUM_WASTE, -37.5},
		{RESOURCE_SILICA, -25},
		{RESOURCE_NITRIC_ACID, -15},
		{RESOURCE_SULFURIC_ACID, -15},
		{RESOURCE_NON_FISSILE_URANIUM, 50},
		{RESOURCE_WATER, 15},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	recipes[RECIPE_TURBO_BLEND_FUEL] = {
		{RESOURCE_FUEL, -15},
		{RESOURCE_HEAVY_OIL_RESIDUE, -30},
		{RESOURCE_SULFUR, -22.5},
		{RESOURCE_PETROLEUM_COKE, -22.5},
		{RESOURCE_TURBOFUEL, 45},
		{RESOURCE_POWER, -POWER_BLENDER}
	};
	
	recipes[RECIPE_INSTANT_PLUTONIUM_CELL] = {
		{RESOURCE_NON_FISSILE_URANIUM, -75},
		{RESOURCE_ALUMINUM_CASING, -10},
		{RESOURCE_ENCASED_PLUTONIUM_CELL, 10},
		{RESOURCE_POWER, -375}
	};
	recipes[RECIPE_NUCLEAR_PASTA] = {
		{RESOURCE_COPPER_POWDER, -100},
		{RESOURCE_PRESSURE_CONVERSION_CUBE, -0.5},
		{RESOURCE_NUCLEAR_PASTA, 0.5},
		{RESOURCE_POWER, -1000}
	};
	recipes[RECIPE_PLUTONIUM_PELLET] = {
		{RESOURCE_NON_FISSILE_URANIUM, -100},
		{RESOURCE_URANIUM_WASTE, -25},
		{RESOURCE_PLUTONIUM_PELLET, 30},
		{RESOURCE_POWER, -500}
	};
	...
	recipes[RECIPE_POWER_NUCLEAR_POWER_PLANT_URANIUM] = {
		{RESOURCE_URANIUM_FUEL_ROD, -0.2},
		{RESOURCE_WATER, -300},
		{RESOURCE_URANIUM_WASTE, 10},
		{RESOURCE_POWER, 2500}
	};
	recipes[RECIPE_POWER_NUCLEAR_POWER_PLANT_PLUTONIUM] = {
		{RESOURCE_PLUTONIUM_FUEL_ROD, -0.1},
		{RESOURCE_WATER, -300},
		{RESOURCE_PLUTONIUM_WASTE, 1},
		{RESOURCE_POWER, 2500}
	};
	recipes[RECIPE_POWER_GEOTHERMAL_IMPURE] = {
		{RESOURCE_POWER, 100}
	};
	recipes[RECIPE_POWER_GEOTHERMAL_NORMAL] = {
		{RESOURCE_POWER, 200}
	};
	recipes[RECIPE_POWER_GEOTHERMAL_PURE] = {
		{RESOURCE_POWER, 400}
	};
...
std::map<RecipeName,float> worldLimits()
{
	std::map<RecipeName,float> limits = {
		...
		{RECIPE_SOURCE_BAUXITE_IMPURE, 5},
		{RECIPE_SOURCE_BAUXITE_NORMAL, 6},
		{RECIPE_SOURCE_BAUXITE_PURE, 6},
		{RECIPE_SOURCE_QUARTZ_IMPURE, 0},
		{RECIPE_SOURCE_QUARTZ_NORMAL, 11},
		{RECIPE_SOURCE_QUARTZ_PURE, 5},
		{RECIPE_SOURCE_URANIUM_IMPURE, 1},
		{RECIPE_SOURCE_URANIUM_NORMAL, 3},
		{RECIPE_SOURCE_URANIUM_PURE, 0},
		{RECIPE_SOURCE_NITROGEN_WELL_A, 1},
		{RECIPE_SOURCE_NITROGEN_WELL_B, 1},
		{RECIPE_SOURCE_NITROGEN_WELL_C, 1},
		{RECIPE_SOURCE_NITROGEN_WELL_D, 1},
		{RECIPE_SOURCE_NITROGEN_WELL_E, 1},
		{RECIPE_SOURCE_NITROGEN_WELL_F, 1},
		{RECIPE_SOURCE_OIL_WELL_A, 1},
		{RECIPE_SOURCE_OIL_WELL_B, 1},
		{RECIPE_POWER_GEOTHERMAL_IMPURE, 3},
		{RECIPE_POWER_GEOTHERMAL_NORMAL, 9},
		{RECIPE_POWER_GEOTHERMAL_PURE, 6},
	};
